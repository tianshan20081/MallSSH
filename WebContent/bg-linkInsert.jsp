...
<table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <br>
        <form action="link?action=0&page=1" onsubmit="return checkEmpty(linkForm)" method="post">
        <table width="53%" height="60"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr>
           ...
           <input type="text" name="link.linkName" />
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;
             <input type="text" name="link.linkAddress" />
