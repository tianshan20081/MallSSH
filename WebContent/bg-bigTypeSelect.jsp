    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
	  ...
	  <table width="90%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
        ...
        <tr bgcolor="#FFFFFF">
          ...
          <td><div align="center"><a href="bigType?action=0&page=1&bigTypeId=<%=form.getId()%>">删除</a></div></td>
      <%}%>  </tr>
      </table>
	  <br>
      ...
      上一页
        <%}else{%>
        <a href="bigType?action=0&page=<%=number-1%>">上一页</a></td>
          <%}%>
          <td width="18%"><%if(maxPage<(number+1)){%>
            下一页
              <%}else{%>
              <a href="bigType?action=0&page=<%=number+1%>">下一页</a></td>
          <%}%>
